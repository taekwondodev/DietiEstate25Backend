...
-- Schema aggiornato - basato su Class Diagram v2
--
...
-- ---------------------------------------------------------------------------
-- TABLE: utenti
-- Nuova tabella che centralizza le credenziali e il ruolo di ogni utente.
-- uid è UUID ed è la PK; corrisponde allo stesso uid usato in utenteagenzia.
-- ---------------------------------------------------------------------------
...
ALTER TABLE public.utenti OWNER TO dietiestate25;

-- ---------------------------------------------------------------------------
-- TABLE: utenteagenzia
-- Collegamento tra utente e agenzia. Il ruolo è ora in utenti.role.
-- ---------------------------------------------------------------------------
...
-- utenti: 1 Admin, 2 Agenti, 2 Clienti
...
-- utenteagenzia: admin e agenti appartengono alle agenzie
INSERT INTO public.utenteagenzia (uid, idagenzia) VALUES
                                                      ('uid-admin-001',  1),
                                                      ('uid-agente-001', 1),
                                                      ('uid-gestore-002', 1);

-- immobile: 3 immobili gestiti dai due agenti
...
-- offerta: 2 offerte su immobili diversi
...
-- visita: 2 visite su immobili diversi
